      ...
      <div className="w-full max-w-4xl mx-auto p-4 md:p-8 space-y-4">
        ...
        <div className="bg-white border-2 border-gray-200 rounded-xl p-6">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="text-sm text-gray-600">🎮 {opponent.matchesPlayed} matches played</div>
          </div>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
          <p className="text-xs font-semibold text-blue-900 mb-2">Verification Required:</p>
          <p className="text-xs text-blue-800">
            You'll need to confirm your opponent's identity matches the person on court before
            recording the full match for official scoring.
          </p>
        </div>
        ...
        <div className="bg-gray-50 rounded-xl p-4 space-y-2">
          <div className="flex items-start gap-2">
            ...
            <p className="text-xs text-gray-700">
              Verify your opponent's profile matches the person on court
            </p>
          </div>
          <div className="flex items-start gap-2">
          ...
          <div className="flex items-start gap-2">
            ...
            <p className="text-xs text-gray-700">
              Upload recording for AI-powered scoring & verification
            </p>
          </div>
        </div>
      </div>
