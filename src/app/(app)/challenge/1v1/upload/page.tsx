    ...
    <main className="min-h-screen bg-white">
      <div className="w-full max-w-4xl mx-auto p-4 md:p-8 space-y-6">
        ...
        <div className="bg-white rounded-xl p-4">
          <p className="text-xs font-semibold text-gray-900 mb-2">What happens next:</p>
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-r-lg">
          <div className="flex items-start gap-2">
            ...
            <p className="text-xs text-yellow-800">
              You'll receive a notification when verification is complete. Results will appear in
              your match history.
            </p>
          </div>
        </div>
